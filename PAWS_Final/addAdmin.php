<?php
	...
	$pic = "Profile_Pics/" . $_POST['adminPic'];
	...
	if ($count==0) {
		...
		$query = "INSERT INTO tbUsers(name,surname,dob,email,password,type,profilepic) VALUES('$uname','$sname','$dob','$email','$password','Admin', '$pic')";
