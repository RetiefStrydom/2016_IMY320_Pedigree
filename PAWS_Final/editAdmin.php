...
<body>
	<div class="container-fluid editAdminAnchors">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12 item">
				<h4 class="grow"><a class="scrollAnchor" href="#currentAdmin">Current Admin</a></h4>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 item">
				<h4 class="grow"><a class="scrollAnchor" href="#addMember">Add Admin</a></h4>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid main">
		<div class="row" id="adminTitle">
			<div class="col-md-12 col-sm-12 col-xs-12 section" id="currentAdmin">
				<h1 class="sectionHeader">Edit Administration:<span class="pull-right"><a class="scrollAnchor" href="#addMember"><img class='image addIcon' src='Icons/addImg.png'></a></span></h1>
				<div class="container-fluid">
						...
						if($events) {
							foreach($adminMembers as $member)
							{
								...
								echo 
								"<div class='row' id='adminMember'>
									<div class='col-md-6 col-sm-6 col-xs-12'>
										<img class='image adminImg' width='250px' height='250px' src='" . $member['profilepic'] . "'/>
									</div>
									<div class='col-md-6 col-sm-6 col-xs-12'>
										<div class='container-fluid'>
											<div class='row'>
												<div class='col-md-12 col-sm-12 col-xs-12' id='details'>
													...
													if($hasEvent) {
														...
														echo "<p>No Event Assigned</p>"; 
													}
											echo "</div>
											</div>
											<div class='row'>
												<div class='col-ms-12 col-sm-12 -col-xs-12' id='controls'>
													<span class='pull-right'><a href='#' id='chooseEvent'><img class='image grow' src='Icons/edit.png' style='margin: 2px;'width='25px'></a><a href='#' id='remove'><img class='image grow' src='Icons/delete.png' style='margin: 2px;'width='25px'></a>
												</div>
											</div>
										</div>
									</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12 section"id="addMember">
				<h1 class="sectionHeader">Add an Admin Member:</h1>
