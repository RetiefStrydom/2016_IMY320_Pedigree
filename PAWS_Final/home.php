...
<body>
	<div class="container-fluid main">
		...
		<?php 	if($type == 'User') {
				...
				echo		"<div class='col-md-1 col-sm-2 col-xs-3 menuItem'>
							<a href='#' class='iconLink' id='editNews'><img class='image image-responsive navIcon grow' src='Icons/editNews.png'/></a>
						</div>
						<div class='col-md-1 col-sm-2 col-xs-3 menuItem'>
				...
				echo "<div class='row navBar'>
						...
						<div class='col-md-2 col-md-offset-2 col-sm-3 col-sm-offset-1 col-xs-4 col-xs-offset-0 menuItem'>
							<a href='#' class='iconLink' id='home'><img class='image navIcon grow' src='Icons/home.png'/></a>
						</div>";
